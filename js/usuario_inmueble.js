...
/*Agregar mora con jquery y ajax*/
  ...
  var myId = $(this).val(); 
        $('#registrar-usuario_mora form#'+myId).submit(function(e) {
             e.preventDefault();
             var informacion=$('#registrar-usuario_mora form#'+myId).serialize();
             var metodo=$('#registrar-usuario_mora form#'+myId).attr('method');
             var peticion=$('#registrar-usuario_mora form#'+myId).attr('action');
             $.ajax({
                type: metodo,
                url: peticion,
                data:informacion,
