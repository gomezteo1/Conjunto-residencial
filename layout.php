								...
								<li class="full-width divider-menu-h"></li>
									<li class="full-width">
										...
										<ul class="full-width menu-principal sub-menu-options">
											...
											<li class="full-width">
											<a href="?controller=mora&action=index" class="full-width">
													<div class="navLateral-body-cl">
													</div>
													<div class="navLateral-body-cr">
														<i class="zmdi zmdi-balance"></i>Mora
													</div>
												</a>
											</li>
											<li class="full-width">
								...
								<?php } else{ ?>
								 ...
								 <div class="Notification-text">
						                <p>
						                    ...
						                    <strong>Notificación Pago</strong> 
						                    <br>
						                    <small>Pago</small>
						                </p>
						            </div>
						...
						<nav class="full-width">
							<ul class="full-width list-unstyle menu-principal">
								...
								<li class="full-width">
									...
									<ul class="full-width menu-principal sub-menu-options">
										<li class="full-width">
											<a href="?controller=usuario&action=indexUsuario" class="full-width">
													<div class="navLateral-body-cl">
													</div>
													<div class="navLateral-body-cr">
...
if(!isset($_SESSION['acceso'])){ ?>
	...
	<header>
		<img src="image/Logo Zamasoft.jpg" class="img-logo">
