								...
								<div class="col-md-12">
									<form action="Controladores/Cuenta_cobro_Controlador.php" method="POST" data-toggle="validator" class="popup-form">
										...
										<div class="row">
											...
											<div class="form-group col-sm-6">
												<div class="help-block with-errors"></div>
												<input value="<?php echo $cuenta_cobro->porMora ?>" name="porMora" id="porMora" placeholder="Mora*" value='<?php echo $cuenta_cobro->porMora; ?>' class="w3-input" type="number" required data-error="La mora"> 
											</div><!-- end form-group -->
